    ...
    return(
      <>
          <footer className="p-4 bg-white sm:p-6 dark:bg-gray-800">
                  ...
                  <div className="md:flex md:justify-between">
                      <div className="mb-6 md:mb-0">
                          <a className="flex items-center">
                              <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Drogas 2.0</span>
                          </a>
                      </div>
                      <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                          ...
                          <div>
                              ...
                              <ul className="text-gray-600 dark:text-gray-400">
                                  <li className="mb-4">
                                      <a href="https://github.com/fur1ozz" className="hover:underline ">Github</a>
                                  </li>
                              </ul>
                          </div>
                          <div>
            ...
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">2023 <a href="#" className="hover:underline">Drogas</a>
            </span>
